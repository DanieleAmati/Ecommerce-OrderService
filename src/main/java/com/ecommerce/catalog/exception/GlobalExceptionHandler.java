...
public class GlobalExceptionHandler {
    ...
    /** Gestisce tutte le CatalogException del dominio */
    @ExceptionHandler(CatalogException.class)
    public Mono<ResponseEntity<Map<String, String>>> handleCatalogException(CatalogException ex) {
        log.debug("[ExceptionHandler] CatalogException: {} → {}", ex.getClass().getSimpleName(), ex.getMessage());
